...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            <form action="{{ route('news1.update', 1) }}" style="width: 100%" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <textarea
                                ...
                                class="form-control"
                                cols="30"
                                rows="10">{{old('annotation', $news1['annotation'])}}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <textarea
                                ...
                                class="form-control"
                                cols="30"
                                rows="10">{{old('content', $news1['content'])}}</textarea>
